  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden bg-paper-line/30">
        ...
        <span className="pointer-events-none absolute right-3 bottom-3 z-10 border border-paper-line/50 bg-paper/30 px-2 py-1 font-mono text-[10px] tracking-[0.1em] text-ink uppercase backdrop-blur-md">
